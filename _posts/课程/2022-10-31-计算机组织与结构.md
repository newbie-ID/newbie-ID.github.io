...
8. 存储器与CPU的连接
	...
	2. 字拓展：CPU和存储器芯片上的数据线数量一致，通过多余的地址线控制片选信号，进行位拓展，两者必须一个工作一个不工作=
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIwNTA0MDYyNiwyNzE3NTg4NDgsNDcwOD
I2MDM3LDExNDU4NjA0NjMsLTIxMTcxMjg3MTUsMTYyNDk5ODYy
NywxMDYzOTMyNDQ1XX0=
-->