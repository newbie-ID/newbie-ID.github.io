...
8. 存储器与CPU的连接
	...
	3. 译码片选法：只用一个地址线，直接连接一个存储器芯片，连接一个取反连接另外一个芯片，达成用一个地址线控制两个芯片的效果=>n条线对应 $2^n$ 个片选信号。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjc2Mzk1NjIwLC0xOTk4NTI4NTUzLDQ3Mz
E1NTE2LDI3MTc1ODg0OCw0NzA4MjYwMzcsMTE0NTg2MDQ2Mywt
MjExNzEyODcxNSwxNjI0OTk4NjI3LDEwNjM5MzI0NDVdfQ==
-->