...
8. 存储器与CPU的连接
	...
	3. 译码片选法：只用一个地址线，直接连接一个存储器芯片，连接一个取反连接另外一个芯片，达成用一个地址线控制两个芯片的效果=>ntiao xian
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0Njc5ODA5OTQsLTE5OTg1Mjg1NTMsND
czMTU1MTYsMjcxNzU4ODQ4LDQ3MDgyNjAzNywxMTQ1ODYwNDYz
LC0yMTE3MTI4NzE1LDE2MjQ5OTg2MjcsMTA2MzkzMjQ0NV19
-->